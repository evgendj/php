...
// Данный классы выполняет функцию сохранения и восстановления объектов с их свойствами. Вместо стандартной сериализации данных используется свой метод (сохранение в более короткую строку вида Имя:ДлиназначенияЗначение и Имя:ДлиназначенияЗначениеСериализованноесвойство и соответственно чтение производится из этих же форматов).
