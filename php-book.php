...
// Объект класса (переменная класса по другому) имеет члены: - свойства - значения различных типов, и - методы - функции, операции, которые могут быть проведены с набором свойств.
