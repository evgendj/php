...
--------------------------  СТАТИЧЕСКИЕ МЕТОДЫ И СВОЙСТВА  ---------863495------
// После модификатора свойства или метода нужно добавить ключ static, тогда их можно использовать в контексте класса. Это нужно если нет необходимости создавать объект, но нужны вычисления внутри класса. К примеру если пишем калькулятор. Говорят Классо Ориентированное Программирование.
...
class NotebookProduct extends Product{ // А это создали новый класс для бука, который наследует продукт и прибавляет проц
  public $cpu;
  function __construct(){}}
...
echo "<hr>";
------------ КОНСТРУКТОРЫ -----------------
// Спец метод со служебными операциями для подготовки объекта. Конструктор автоматически включается при создании объекта. Делаем тоже что и выше, но с использованием конструктора
class Entree2 {
	public $name;
