...
// Переменные. Начинается только с буквы или _ знак подчеркивания. Допускаются только буквы (кириллицу лучше не использовать), цифры и _ . и еще какие-то символы из кодировки. Регистрочувствительно.
...
echo "<hr>";
// Типы переменных. PHP логически понимает переменные которые вводятся. Но тип можно указывать явно.
// int - целое число
// float - число с плавающей точкой
// array - массив
// string - строка
// bool - логическое значение true или false
// callable - что-то представляющее функцию или метод, который можно вызвать
