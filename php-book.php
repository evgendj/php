...
instanceof // Выводит правду или ложь - var_dump($a instanceof A); - является ли объект объектом класса А. Но при этом если у класса А есть родитель, то объект $a будет принадлежать и к класу родителя, и эта функция покажет тру на оба класса
