...
--------------------------  МЕТОД  ---------------------------------------------
// Имя метода принято начинать с мальенькой буквы, а последующие слова с большой, слитно. Модификаторы не обязательны, по умолчанию - публичный.
// Чтобы не писать каждый раз вывод на экран значений свойств при создании нового объекта, можно и нужно этот вывод занести в метод:
class Car
{
  public $color;
  public $wheels = 4;
